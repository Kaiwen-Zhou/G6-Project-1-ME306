...
PlotterApplication::PlotterApplication()
    : encoderA_(true), encoderB_(false),
      leftLimit_(PinConfig::LIMIT_SWITCH_LEFT_PIN, 
                 SystemConfig::LIMIT_SWITCH_INPUT_MODE,
                 SystemConfig::LIMIT_SWITCH_DEBOUNCE_MS),
      rightLimit_(PinConfig::LIMIT_SWITCH_RIGHT_PIN, 
                  SystemConfig::LIMIT_SWITCH_INPUT_MODE,
                  SystemConfig::LIMIT_SWITCH_DEBOUNCE_MS),
      bottomLimit_(PinConfig::LIMIT_SWITCH_BOTTOM_PIN, 
                   SystemConfig::LIMIT_SWITCH_INPUT_MODE,
                   SystemConfig::LIMIT_SWITCH_DEBOUNCE_MS),
      ...
      motorA_(PinConfig::MOTOR_1_DIRECTION_PIN, 
              ...
              MOTOR_OUTPUT_LIMIT),
      motorB_(PinConfig::MOTOR_2_DIRECTION_PIN, 
              PinConfig::MOTOR_2_PWM_PIN, 
              SystemConfig::MOTOR_2_DIRECTION_INVERTED,
              MOTOR_OUTPUT_LIMIT),
      pidA_(INITIAL_A_KP, INITIAL_A_KI, 
            CONTROLLER_MINIMUM_OUTPUT, 
            CONTROLLER_MAXIMUM_OUTPUT, 
            INTEGRAL_MINIMUM_OUTPUT,
            INTEGRAL_MAXIMUM_OUTPUT, INITIAL_A_KV),
      pidB_(INITIAL_B_KP, INITIAL_B_KI, 
            CONTROLLER_MINIMUM_OUTPUT, CONTROLLER_MAXIMUM_OUTPUT, 
            INTEGRAL_MINIMUM_OUTPUT, INTEGRAL_MAXIMUM_OUTPUT, 
            INITIAL_B_KV),
      ...
      homingController_(encoderA_, encoderB_, 
                        motorA_, motorB_, 
                        converter_, 
